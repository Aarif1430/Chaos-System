...
function setup() {
  ...
  pendulum1.bodies[0].render.strokeStyle = "#ffffff";
  pendulum1.bodies[1].render.strokeStyle = "#ffffff";
  pendulum1.bodies[2].render.strokeStyle = "#ffffff";
  pendulum1.bodies[3].render.strokeStyle = "#ffffff";
  pendulum1.bodies[4].render.strokeStyle = "#ffffff";
  pendulum1.bodies[5].render.strokeStyle = "#ffffff";
  ...
  Composite.add(
    ...
    Constraint.create({
      ...
      pointA: {
        x: pendulum1.bodies[1].position.x - length * 0.42,
        y: pendulum1.bodies[1].position.y,
      },
      stiffness: 0.9,
      length: 0,
      render: {
